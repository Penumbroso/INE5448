...
public class TesteMercadoVendedor {
	...
	public void iniciar() throws Exception {
		...
		cpfLeiloadorProduto = "111.111.111-94";
	...
	public void obterUmUsuario() throws Exception {
		IUsuario usuario = mercado.getUsuario(cpfUsuario);
